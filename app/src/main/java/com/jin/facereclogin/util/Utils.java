...
//            androidId = info.getMacAddress();
    ...
    public static void showDialog(Context activity, String msg, DialogInterface.OnClickListener listener) {
        Dialog dialog = new android.app.AlertDialog.Builder(activity)
                .setMessage(msg)
                .setPositiveButton(activity.getString(R.string.confirm), listener)
                .create();
        dialog.show();
    }
}
