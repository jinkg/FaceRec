...
public class CreateGesturePasswordActivity extends Activity implements
    ...
    public static void open(Activity context) {
        Intent intent = new Intent(context, CreateGesturePasswordActivity.class);
    ...
    private void saveChosenPatternAndFinish() {
        LockPatternUtils.getInstance(this).saveLockPattern(mChosenPattern);
        Toast.makeText(this, getString(R.string.gesture_password_set_success), Toast.LENGTH_SHORT).show();
        finish();
    }
}
