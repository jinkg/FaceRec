package com.jin.gesturepassword.widget;
...
public class LockPatternUtils {
    private static final String LOCK_PATTERN_SP = "lock_pattern";
    ...
    public static LockPatternUtils getInstance(Context context) {
        if (sInstance == null) {
            sInstance = new LockPatternUtils(context);
        }
        return sInstance;
    }
     ...
     */
    public boolean savedPatternExists(Context context) {
        if (!isEnable(context)) {
            return false;
        }
    ...
    public boolean savedPatternJustExists() {
        return sHaveNonZeroPatternFile.get();
    }
    ...
    public boolean isEnable(Context context) {
        SharedPreferences sp = context.getSharedPreferences(
                LOCK_PATTERN_SP, Context.MODE_PRIVATE);
        return sp.getBoolean(ENABLE_KEY, true);
    }

    public void enableLock(Context context, boolean enable) {
        SharedPreferences sp = context.getSharedPreferences(
                LOCK_PATTERN_SP, Context.MODE_PRIVATE);
